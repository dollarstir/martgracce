...
class Loig extends StatefulWidget {
  Loig({Key key}) : super(key: key);

  _LoigdState createState() => _LoigdState();
}

class _LoigdState extends State<Loig> {
 num position = 1;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: IndexedStack(
        ...
        children: <Widget>[
          WebView(
            initialUrl: "https://www.martgrace.com/login",
